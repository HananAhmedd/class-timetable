...
// Fetch all classmates except the logged-in user
$sql = "SELECT name FROM users WHERE role = 'student' AND name != ?";
...
<head>
  ...
  <title>Students Management | University of Messina</title>
  ...
  <style>
    ...
    .sidebar {
      width: 250px;
      background: linear-gradient(180deg, #2a1b5a, #341a8c);
      padding: 20px;
      position: fixed;
      height: 100vh;
...
<!-- ✅ SIDEBAR -->
<div class="sidebar">
  <img src="images/messina-logo.png" alt="Unime Logo">
