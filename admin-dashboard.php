  ...
  <div class="admin-tips">
    ...
    <div class="tips-list">
      ...
      <div class="tip-card text-center">
        ...
        <p>Send out announcements and keep everyone in the loop.</p>
      </div>
      <div class="tip-card text-center">
        <i class="fas fa-shield-alt"></i>
        <p>Monitor system activity and ensure secure data access.</p>
      </div>
    </div>
  </div>
